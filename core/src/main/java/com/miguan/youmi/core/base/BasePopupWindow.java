package com.miguan.youmi.core.base;/*
 ...
 *
 * @see <a href="https://github.com/JessYanCoding/MVPArms/wiki#3.7">BasePopupWindow wiki 官方文档</a>
...
public class BasePopupWindow extends PopupWindow {
    ...
    private void initLayout() {
        mListener.initPopupView(this, mContentView);
...
//        setTouchable(isTouchable);
    ...
    public void showAsMenu() {
        View parentView = mParentView == null ? mContentView : mParentView;
        if (Build.VERSION.SDK_INT < 24) {
            ...
            int x = location[0];
            int y = location[1];
            setHeight(ScreenUtils.getScreenHeight() - y - parentView.getHeight());
            showAtLocation(parentView, Gravity.NO_GRAVITY, 0, y + parentView.getHeight());
        }
        mIsShowing = true;
    }
    ...
    public interface CustomPopupWindowListener {
        void initPopupView(BasePopupWindow window, View contentView);
    }
    ...
    public static final class Builder {
        ...
        private boolean isTouchable = true; // 默认为true
        ...
        public Builder onDismissListener(OnDismissListener dismissListener) {

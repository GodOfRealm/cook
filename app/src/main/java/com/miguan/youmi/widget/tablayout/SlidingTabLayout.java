package com.miguan.youmi.widget.tablayout;
...
import com.miguan.youmi.widget.tablayout.listener.OnTabSelectListener;
import com.miguan.youmi.widget.tablayout.utils.UnreadMsgUtils;
import com.miguan.youmi.widget.tablayout.widget.MsgView;
                    ...
                    if (mViewPager != null) {
                        if (mViewPager.getCurrentItem() != position) {
                            ...
                            if (mListener != null) {
                                ...
                                if (time - mLastTime < 600) {
                                    mListener.onTabDoubleClick(position);
                                }
                                mLastTime = time;
                            }
                        }
...
//            v.setPadding((int) mTabPadding, v.getPaddingTop(), (int) mTabPadding, v.getPaddingBottom());
     ...
     * @param index
     */
    public void goScrollTo(int index)
    {
        mCurrentTab = index;
    ...
    //添加tab，并且drawleft
    public void addNewTab(String title , int id) {
        View tabView = View.inflate(mContext, R.layout.layout_tab, null);
    ...
    private void calcIndicatorRect() {
        ...
        if (mIndicatorStyle == STYLE_NORMAL && mIndicatorWidthEqualTitle) {
            ...
            mTextPaint.setTextSize(isSelected() ? mTextSelectSize : mTextUnselectSize);
            float textWidth = mTextPaint.measureText(tab_title.getText().toString())+getContext().getResources().getDimensionPixelSize(R.dimen.bdp_4);

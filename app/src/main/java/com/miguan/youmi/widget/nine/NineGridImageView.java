package com.miguan.youmi.widget.nine;
...
public class NineGridImageView<T> extends ViewGroup {
    ...
    private boolean mGridHour = false;          //四张图片的是否fill，当mShowStyle为STYLE_FILL生效
    ...
    private void layoutForNoSpanChildrenView(int childrenCount) {
        ...
        if(childrenCount == 4 && mGridHour && mSpanType == STYLE_GRID){
            columnCount--;
        }
    ...
    public void setGridHour(boolean gridHour) {
        mGridHour = gridHour;
    }
}
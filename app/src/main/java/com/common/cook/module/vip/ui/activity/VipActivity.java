package com.common.cook.module.vip.ui.activity;
...
import com.common.cook.module.vip.di.component.DaggervipComponent;
import com.common.cook.module.vip.di.module.vipModule;
import com.common.cook.module.vip.presenter.vipPresenter;
...
@Route(path = ARouterPaths.VIP_HOME)
public class VipActivity extends BaseActivity<vipPresenter> implements vipContract.View {
    ...
    public int initView(@Nullable Bundle savedInstanceState) {
        return R.layout.vip_activity_vip; //如果你不需要框架帮你设置 setContentView(id) 需要自行设置,请返回 0
    }
